...
var dayjs_min = require('../../../_chunks/dep-25af0a61.js');
var customParseFormat = require('../../../_chunks/dep-10991fb8.js');
...
function validateInputValue(value, format) {
  return dayjs_min.dayjs(value, format).format(format) === value;
}
function formatInputValue(value, format) {
  return dayjs_min.dayjs(value, format).format(format);
}

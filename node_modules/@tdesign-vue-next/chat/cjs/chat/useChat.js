...
var chat_sseRequest = require('./sseRequest.js');
var chat_sseRequestHunyuan = require('./sseRequest-hunyuan.js');
...
function useChat(props, emit) {
  ...
  if (welcome.length > 0) {
    welcome.forEach(function (item) {
      chatList.value.unshift({
        ...
        datetime: chat_util.formatDateByRule(new Date(), "yyyy/MM/dd hh:mm:ss"),
        content: item,
        role: "system"
      });
    });
  ...
  var innerFetchSSE = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(url, params, sseRequest2) {
      var lastItem;
  ...
  var getParams = function getParams(type, inputValue, modelOrMofaId) {
    var paramsMap = {
      hunyuan: {
        ...
        url: chat_util.getUrl(props.model),
        sseRequest: chat_sseRequestHunyuan.sseRequest,
        fetchSSE: chat_sseRequestHunyuan.fetchSSE
      },
      mofa: {
        reqData: {
          query: inputValue,
        ...
        url: chat_util.getMofaUrl(),
        sseRequest: chat_sseRequest.sseRequest,
        fetchSSE: chat_sseRequest.fetchSSE
      }
    };
  ...
  var sendRequest = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(type, inputValue, modelOrMofaId) {

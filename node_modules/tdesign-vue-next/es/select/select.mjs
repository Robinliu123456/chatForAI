...
import { _ as _asyncToGenerator, r as regenerator } from '../_chunks/dep-1cd1bc71.mjs';
import { _ as _toConsumableArray } from '../_chunks/dep-87669a0e.mjs';
...
var _Select = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var onCheckAllChange = function onCheckAllChange(checked) {
      ...
      var values = checked ? _toConsumableArray(/* @__PURE__ */new Set([].concat(_toConsumableArray(orgValue.value), _toConsumableArray(activeValues), _toConsumableArray(lockedValues)))) : _toConsumableArray(lockedValues);

...
var slider_utils_index = require('./utils/index.js');
...
var _Slider = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var firstValue = Vue.ref(slider_utils_index.formatSliderValue(sliderValue.value, "first"));
    var secondValue = Vue.ref(slider_utils_index.formatSliderValue(sliderValue.value, "second"));
    ...
    return function () {
      return Vue.createVNode("div", {
        ...
        return Vue.createVNode("div", {
          ...
          "key": key,
          "style": slider_utils_index.getStopStyle(item, vertical.value)
        }, null);

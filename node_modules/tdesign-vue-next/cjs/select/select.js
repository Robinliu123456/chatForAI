...
var cloneDeep = require('../_chunks/dep-b75e3209.js');
var intersection = require('../_chunks/dep-a0482c90.js');
...
var _Select = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var onCheckAllChange = function onCheckAllChange(checked) {
      ...
      var lockedValues = innerValue.value.filter(function (value2) {
        return optionsList.value.find(function (item) {
          return item.value === value2 && item.disabled;
        });
      });
      var activeValues = optionalList.value.map(function (option) {
        return option.value;
      });
      var values = checked ? _toConsumableArray__default["default"](/* @__PURE__ */new Set([].concat(_toConsumableArray__default["default"](orgValue.value), _toConsumableArray__default["default"](activeValues), _toConsumableArray__default["default"](lockedValues)))) : _toConsumableArray__default["default"](lockedValues);

...
var _Rate = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var activeColor = isArray.isArray(props2.color) ? props2.color[0] : props2.color;
    var defaultColor = isArray.isArray(props2.color) ? props2.color[1] : "var(--td-bg-color-component)";

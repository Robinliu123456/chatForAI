...
declare const _default: import("vue").DefineComponent<{
    ...
    tableBodyRef: import("vue").Ref<import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        ...
        firstFullRow: PropType<string | ((h: typeof import("vue").h) => import("..").TNodeReturnValue)> | {
            type: PropType<import("./type").TdBaseTableProps["firstFullRow"]>;
        };
        fixedRows?: {
            type: PropType<import("./type").TdBaseTableProps["fixedRows"]>;
        ...
        lastFullRow: PropType<string | ((h: typeof import("vue").h) => import("..").TNodeReturnValue)> | {
            type: PropType<import("./type").TdBaseTableProps["lastFullRow"]>;
        };
        lazyLoad?: BooleanConstructor;
        loading?: {
        ...
        rowAndColFixedPosition: PropType<import("./tbody").TableBodyProps["rowAndColFixedPosition"]>;
        showColumnShadow: PropType<import("./tbody").TableBodyProps["showColumnShadow"]>;
        tableElm: {};
        tableWidth: NumberConstructor;
        isWidthOverflow: BooleanConstructor;
        virtualConfig: PropType<import("../hooks/useVirtualScrollNew").VirtualScrollConfig>;
        tableContentElm: {};
        handleRowMounted: PropType<import("./tbody").TableBodyProps["handleRowMounted"]>;
        renderExpandedRow: PropType<import("./tbody").TableBodyProps["renderExpandedRow"]>;
...
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, import("vue").EmitsOptions, "show-element-change", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
    renderExpandedRow: PropType<BaseTableProps["renderExpandedRow"]>;
    onLeafColumnsChange: PropType<BaseTableProps["onLeafColumnsChange"]>;
    thDraggable: BooleanConstructor;
    activeRowKeys: {

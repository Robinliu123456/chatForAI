...
export declare const DescriptionsItem: {
    new (...args: any[]): import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        content: {
            type: import("vue").PropType<TdDescriptionItemProps["content"]>;
        };
        default: {
            type: import("vue").PropType<TdDescriptionItemProps["default"]>;
        };
        label: {
            type: import("vue").PropType<TdDescriptionItemProps["label"]>;
        };
        span: {
            type: NumberConstructor;
            default: number;
